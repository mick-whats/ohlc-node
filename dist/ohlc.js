...
_ = __webpack_require__(/*! ../../node_modules/lodash/lodash.min.js */ "./node_modules/lodash/lodash.min.js");

moment = __webpack_require__(/*! ../../node_modules/moment/min/moment.min.js */ "./node_modules/moment/min/moment.min.js");

DATE_FORMAT = 'YYYY-MM-DD';

Ohlc = (function() {
  var _addSma, _addVwma, _convertingPeriodBy;
  ...
  _addSma = function(range, items, round) {
    var key;
    key = `sma${range}`;
    items.forEach(function(item, i, arr) {
      ...
      if (i < range - 1) {
        ...
        return item[key] = round(_.meanBy(refItems, 'Close'));
      }
    });
    return items;
  };

  _addVwma = function(range, items, round) {
    var key;
    key = `vwma${range}`;
    items.forEach(function(item, i, arr) {
      var refItems, sumPrice, sumVolume;
      if (i < range - 1) {
        return item[key] = null;
      } else {
        refItems = arr.slice(i - (range - 1), +i + 1 || 9e9);
        sumPrice = _.sumBy(refItems, function(o) {
          return o.Close * o.Volume;
        });
        sumVolume = _.sumBy(refItems, 'Volume');
        return item[key] = round(sumPrice / sumVolume);
      }
    });
    return items;
  };
  ...
  _convertingPeriodBy = function(period, items, opts) {
    ...
    if (opts.smas) {
      opts.smas.forEach(function(range) {
        return _addSma(range, items, opts.round);
      });
    }
    if (opts.vwmas) {
      opts.vwmas.forEach(function(range) {
        return _addVwma(range, items, opts.round);
      });
    }
...
/***/ 0:
/*!******************************************************!*\
  !*** multi babel-polyfill ./coffee/lib/index.coffee ***!
  \******************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

__webpack_require__(/*! babel-polyfill */"./node_modules/babel-polyfill/lib/index.js");
module.exports = __webpack_require__(/*! ./coffee/lib/index.coffee */"./coffee/lib/index.coffee");
